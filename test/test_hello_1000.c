...
#include "./../hello_1000/main.c"

/* Define AKA for call run_challenge */
#define RUN_CHALLENGE run_challenge_hello_1000
...
static int setup_test_hello_1000(void) {
    printf("\ncall %s from %s\n", __func__, __FILE__);
    return 0;
}

static int tear_down_test_hello_1000(void) {
    printf("\ncall %s from %s\n", __func__, __FILE__);
    return 0;
}

ITEM_SUIT_TEST* setup_suit_test_hello_1000(int *amount_test, char *s_name_suit, int amount_char_suit_name) {
    int amount_char_writted = 0;
    static ITEM_SUIT_TEST suit_test;
    static ITEM_TEST_FUNCTION cb_lst_test[] = {
        { "test_challenge_1_hello_1000", test_challenge_1_hello_1000 },
        { "test_challenge_1_hello_1000_dup", test_challenge_1_hello_1000 },
    };
    *amount_test = sizeof(cb_lst_test) / sizeof(ITEM_TEST_FUNCTION);
    ...
    suit_test.cb_setup_test = (SETUP_TEST_FUNCTION)setup_test_hello_1000;
    suit_test.cb_tear_down_test = tear_down_test_hello_1000;    
